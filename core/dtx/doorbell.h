...
class LockReadBatch : public DoorbellBatch {
 public:
  ...
  void SetLockReq(char *local_addr, uint64_t remote_off, LockType type,
...
class WriteUnlockBatch : public DoorbellBatch {
 public:
  ...
  void SetUnLockReq(char *local_addr, uint64_t remote_off, LockType type,
                    uint64_t compare_add, uint64_t swap);
...
class InvisibleWriteBatch : public DoorbellBatch {
 public:
  ...
  void SetInvisibleReq(char *local_addr, uint64_t remote_off, uint64_t compare,
                       uint64_t swap);
  ...
  bool SendReqsSync(CoroutineScheduler *coro_sched, RCQP *qp, coro_id_t coro_id,
                    int use_cas);
};
